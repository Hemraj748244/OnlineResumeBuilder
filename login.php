...
if(isset($_POST['btnsubmit']))
{
    ...
    $qry="select * from userdata where email='$email' && password='$password' ";
    ...
    else
    {
    	  ...
    	  $_SESSION['uid']=$row['userid'] ?: null;
    	  $_SESSION['uname']=$row['username'] ?: null;
    	  $userkiid=$_SESSION['uid'];
          $qrycheck="select * from personal where uid='$userkiid'";
          $datacheck=mysqli_query($con,$qrycheck);
