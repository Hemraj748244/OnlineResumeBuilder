...
<div class="container-fluid">
 ...
 <table class="table table-striped">
  ...
  echo "<td>".$percent."</td>";
   ?>
  <td><button type="submit" name="btnupdate" onClick="location.href='updateprojects.php'" class="btn btn-primary">UPDATE</button></td>
  <td><button type="submit" name="btnnext" class="btn btn-primary">DELETE</button></td>
  <?php
  echo "</tr>";
  }
  ?>
