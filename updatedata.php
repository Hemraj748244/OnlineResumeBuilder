...
<div class="container-fluid">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
                ...
                <div class="panel-body">
                           ...
                           <div class="row">
                            <div class="col-sm-6">
                      <button type="button" name="btnupdate" class="btn btn-primary btn-block" onClick="location.href='updatepersonal.php'" >UPDATE</button>
                    </div>
                    <div class="col-sm-6">
                      <button type="button" name="btnnext" class="btn btn-primary btn-block">DELETE</button>
                    </div>                          
                           </div>
 ...
 <table class="table table-striped">
  ...
  <div class="row">
         <div class="col-sm-6">
                      <button type="button" name="btnupdate" class="btn btn-primary btn-block" onClick="location.href='updateeducation.php'">UPDATE</button>
                    </div>
                    <div class="col-sm-6">
  ...
  ?>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <button type="button" name="btnupdate" class="btn btn-primary btn-block" onClick="location.href='updateexperience.php'">UPDATE</button>
                    </div>
                    <div class="col-sm-6">
                      <button type="submit" name="btnnext" class="btn btn-primary btn-block">DELETE</button>
                    </div>
 ...
 <div class="row">
                            <div class="col-sm-6">
                      <button type="submit" name="btnupdate" onClick="location.href='updateprojects.php'" class="btn btn-primary btn-block">UPDATE</button>
                    </div>
                    <div class="col-sm-6">
                      <button type="submit" name="btnnext" class="btn btn-primary btn-block">DELETE</button>
                    </div>                          
     ...
     echo "<li>".$skill5."</li>";
       ...
       echo "</ul>";
         ?>
          <div class="row">
                            <div class="col-sm-6">
                      <button type="submit" name="btnupdate" onClick="location.href='updateskills.php'" class="btn btn-primary btn-block">UPDATE</button>
                    </div>
                    <div class="col-sm-6">
                      <button type="submit" name="btnnext" class="btn btn-primary btn-block">DELETE</button>
                    </div>                          
 ...
 <div class="panel panel-default">
  ...
  ?>
   <div class="row">
                            <div class="col-sm-6">
                      <button type="submit" name="btnupdate" onClick="location.href='updatesoftwares.php'" class="btn btn-primary btn-block">UPDATE</button>
                    </div>
                    <div class="col-sm-6">
                      <button type="submit" name="btnnext" class="btn btn-primary btn-block">DELETE</button>
                    </div>                          
     ...
     echo "<li>".$h4."</li>";
       ...
       echo "</ul>";
         ?>
          <div class="row">
                            <div class="col-sm-6">
                      <button type="submit" name="btnupdate" onClick="location.href='updatehobbies.php'" class="btn btn-primary btn-block">UPDATE</button>
                    </div>
                    <div class="col-sm-6">
                      <button type="submit" name="btnnext" class="btn btn-primary btn-block">DELETE</button>
                    </div>                          
